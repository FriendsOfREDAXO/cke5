...
<style>
    ...
    .cke5-upload-dropzone.active {
        border-color: #2b7dc0;
        background-color: #f7f7f7;
    }

    .cke5-upload-dropzone i {
        font-size: 40px;
        margin-bottom: 10px;
        color: #666;
    }
    ...
    .cke5-upload-status .filename {
        font-weight: bold;
        vertical-align: middle;
    }

    .cke5-upload-status .files-list {
        max-height: 200px;
        overflow-y: auto;
    }

    .cke5-upload-status .no-files {
        font-style: italic;
        color: #666;
        padding: 5px;
    }

    .cke5-upload-status .file-item {
        display: flex;
    ...
    .cke5-upload-status .file-item:last-child {
        border-bottom: none;
    }

    .cke5-upload-status .file-item:hover {
        background-color: rgba(0, 0, 0, 0.03);
    }

    .cke5-upload-status .btn-delete {
        color: #d9534f;
        background: none;
        border: none;
        cursor: pointer;
    ...
    .cke5-upload-status .btn-delete:hover {
        color: #c9302c;
    }
    ...
    @media (prefers-color-scheme: dark) {
        .rex-theme-dark .cke5-upload-dropzone {
            border-color: #444;
        }

        .rex-theme-dark .cke5-upload-dropzone.active {
            border-color: #3c7dbe;
            background-color: #33373f;
        }

        .rex-theme-dark .cke5-upload-dropzone i {
            color: #aaa;
        }

        .rex-theme-dark .cke5-upload-status {
            background-color: #33373f;
        }

        .rex-theme-dark .cke5-upload-status .no-files {
            color: #aaa;
        }

        .rex-theme-dark .cke5-upload-status .file-item {
            border-bottom-color: #444;
        }

        .rex-theme-dark .cke5-upload-status .file-item:hover {
