...
$sql->ensurePrimaryIdColumn()
    ...
    ->ensureColumn(new rex_sql_column('balloon_toolbar_custom', 'varchar(255)', true))
    ->ensureColumn(new rex_sql_column('balloon_toolbar', 'text', true))
    ->ensureColumn(new rex_sql_column('editor_type', 'varchar(32)', true))
    ...
    ->ensureColumn(new rex_sql_column('paste_plain_text_default', 'varchar(255)', true))
    ->ensureColumn(new rex_sql_column('markdown_paste', 'varchar(255)', true))
    ->ensureColumn(new rex_sql_column('minimap', 'varchar(255)', true))
    ...
    ->ensureColumn(new rex_sql_column('table_classes_definition', 'text', true))
    ->ensureColumn(new rex_sql_column('table_column_classes_definition', 'text', true))
    ->ensureColumn(new rex_sql_column('table_row_classes_definition', 'text', true))
    ->ensureColumn(new rex_sql_column('table_cell_classes_definition', 'text', true))
    ...
    ->ensureColumn(new rex_sql_column('document_title', 'varchar(255)', true))
    ...
    ->ensureColumn(new rex_sql_column('media_embed_styles_definition', 'text', true))
    ->ensureColumn(new rex_sql_column('media_embed_width_styles_definition', 'text', true))
    ->ensureColumn(new rex_sql_column('video_styles_definition', 'text', true))
    ->ensureColumn(new rex_sql_column('video_width_styles_definition', 'text', true))
    ->ensureColumn(new rex_sql_column('clear_widget_preset', 'varchar(64)', true))
    ->ensureColumn(new rex_sql_column('video_controls_default', 'varchar(255)', true))
    ->ensureColumn(new rex_sql_column('video_autoplay_default', 'varchar(255)', true))
    ->ensureColumn(new rex_sql_column('video_muted_default', 'varchar(255)', true))
    ->ensureColumn(new rex_sql_column('video_loop_default', 'varchar(255)', true))
    ->ensureColumn(new rex_sql_column('video_playsinline_default', 'varchar(255)', true))
    ...
    ->ensureColumn(new rex_sql_column('snippets', 'text', true))
...
// install snippets database
$sql = rex_sql_table::get(rex::getTable('cke5_snippets'));
$sql->ensurePrimaryIdColumn()
    ->ensureColumn(new rex_sql_column('name', 'varchar(100)', true))
